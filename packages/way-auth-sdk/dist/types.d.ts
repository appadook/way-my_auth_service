...
export type WayAuthErrorCode = "email_taken" | "forbidden" | "internal_error" | "invalid_credentials" | "invalid_input" | "invalid_json" | "invalid_origin" | "expired_refresh_token" | "invalid_refresh_token" | "invalid_session_id" | "invalid_signup_secret" | "invalid_token" | "login_failed" | "missing_bearer_token" | "missing_refresh_token" | "rate_limited" | "session_not_found" | "signup_failed";
